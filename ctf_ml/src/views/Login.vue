...
<template>
  <div class="mx-auto min-h-screen flex flex-col py-32pt px-32pt md:py-32pt md:px-64pt" data-v-inspect="false"
    data-debug-id="0xAFF923">
    ...
    <main class="grow">
      ...
      <form @submit.prevent="handleLogin" class="flex flex-col gap-16pt w-full md:w-1/3 mx-auto relative">
        ...
        <div style="display: none !important;" aria-hidden="true" class="legacy-metadata-store"
          data-payload="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9" data-fragment="CTF(haha_got_you!)"
        ...
        <div class="flex flex-col gap-4pt">
          ...
          <input v-model="login" type="text"
            ...
            placeholder="CTF(user)" :disabled="isLoading" required />
        </div>
        ...
        <div class="flex flex-col gap-4pt">
          ...
          <input v-model="password" type="password"
            class="bg-transparent border-[3px] border-ui-white/20 focus:border-ui-accent outline-none px-8pt py-8pt font-mono text-ui-white transition-colors disabled:opacity-50"
            placeholder="CTF(********)" :disabled="isLoading" required />
        </div>
        ...
        <div class="mt-8pt">
          <Button white fullWidth type="submit" :disabled="isLoading" class="relative">
